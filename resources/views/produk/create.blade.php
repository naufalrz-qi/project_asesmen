                        ...
                        <form class="forms-sample" method="POST" action="{{ route('produk.store') }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select class="js-example-basic-single form-select" name="status_produk" data-width="100%">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="js-example-basic-single form-select" name="kelompok_produk_id" data-width="100%">
